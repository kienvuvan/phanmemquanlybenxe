 ...
 * @author kienanh2903
 */
public class HomeGuestForm extends javax.swing.JFrame {
    ...
    public HomeGuestForm() {
        ...
        setVisiablePrevious();
        setVisiableNext();
        ic.displayInformation(jPanel_information, jPanel_news, listInformations, stt);
    }
    ...
    private void initComponents() {
        ...
        jPanel_newsLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_newsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel_newsLayout.createSequentialGroup()
                    .addComponent(jPanel_information, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabel_nextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_nextMouseClicked
        ...
        if (stt <= checkStt) {
            ...
            jPanel_information.revalidate();
            jPanel_information.repaint();
            ic.displayInformation(jPanel_information, jPanel_news, listInformations, stt);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeGuestForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeGuestForm().setVisible(true);
            }
        });
    }
